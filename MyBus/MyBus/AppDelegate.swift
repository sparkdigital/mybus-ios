...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: "applicationDidBecomeActive"), object: nil, userInfo: nil)
    }
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "SparkDigital.MyBus" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "MyBus", withExtension: "momd")!
