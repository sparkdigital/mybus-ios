...
class BusRouteCombinedTest: XCTestCase
{
    ...
    override func setUp()
    {
        ...
        let firstFilePath = Bundle(for: BusRouteCombinedTest.self).path(forResource: "BusRouteResultCombined_1", ofType: "json")
        let secondFilePath = Bundle(for: BusRouteCombinedTest.self).path(forResource: "BusRouteResultCombined_2", ofType: "json")
